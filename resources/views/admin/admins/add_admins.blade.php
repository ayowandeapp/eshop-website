...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
            <a href="#">Admins</a> <a href="#" class="current">Add Admins/Sub Admins</a> </div>
        <h1>Admins</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('/admin/add-admins') }}" name="add_admins" id="add_admins" novalidate="novalidate"> {{ csrf_field() }}
                            <div id="fieldList">
                            ...
                            <div class="form-actions">
                                <!-- <button id="addMore" class="btn btn-primary"> Add More Field</button> --> <input type="submit" value="Add Admin" class="btn btn-success">
                            </div>
                        </form>
                    </div>
                </div>

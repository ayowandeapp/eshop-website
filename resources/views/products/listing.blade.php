...
<div class="features_items"><!--features_items-->
    <h2 class="title text-center">{{ $categoryDetails->name }} ({{ count($productAll) }})</h2>
        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                <div class="productinfo text-center">
                   <a href="{{ url('/product/'.$product->id) }} "><img src="{{ asset('/images/backend_images/products/large/'.$product->image) }}" alt="" /></a>
                    <h2>${{ $product->price }}</h2>
